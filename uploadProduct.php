					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Sword" style="color: black;">Sword</option>
								  <option value="Notes & coins" style="color: black;">Notes & coins</option>
								  <option value="Jewellery" style="color: black;">Jewellery</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
