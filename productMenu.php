							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="fruit" style="color: black;">Swords</option>
										<option value="vegetable" style="color: black;">Notes</option>
										<option value="grain" style="color: black;">Jewellery</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
